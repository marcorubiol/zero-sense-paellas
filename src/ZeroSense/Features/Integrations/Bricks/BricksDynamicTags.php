...
class BricksDynamicTags implements FeatureInterface
{
    ...
    private function getRabbitToggle($post): string
    {
        ...
        return '<input type="hidden" name="zs_rabbit_choice" value="with">'
            ...
            . 'if(this._zsUrl&&this._zsUrl.indexOf("admin-ajax.php")>-1&&typeof body==="string"&&body.indexOf("action=zs_add_to_cart")>-1){'
            . 'var params=new URLSearchParams(body);'
            . 'var pid2=params.get("product_id");'
            . 'var choice=(window._zsRabbitChoice&&pid2&&window._zsRabbitChoice[pid2])||"with";'
