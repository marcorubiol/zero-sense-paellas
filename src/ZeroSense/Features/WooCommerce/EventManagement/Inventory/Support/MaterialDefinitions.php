...
class MaterialDefinitions
{
    ...
    public static function getAll(): array
    {
        return [
            ...
            // EQUIPAMENT PAELLA — cremadors
            [
                'key' => 'cremador_50cm',
                'label' => 'Cremador 50cm',
                'category' => 'cremadors',
                'parent_category' => 'equipament_paella',
                'unit' => 'u',
            ...
            // LOGÍSTICA — equipament pesant (Carretó)
            [
                'key' => 'carreto',
                'label' => 'Carretó',
            ...
            // EQUIPAMENT PAELLA — potes i butà
            [
                'key' => 'potes_tripodes',
