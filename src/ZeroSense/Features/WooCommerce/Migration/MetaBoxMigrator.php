 ...
 * 
 * Last tested: 2026-01-26 via webhook deploy - Force script update
 */
class MetaBoxMigrator
{
    /**
     * Field mapping from MetaBox to ZeroSense
     */
    ...
    /**
     * Count orders with MetaBox fields
     */
    ...
    /**
     * Perform migration for all pending orders
     */
    ...
    public function migrateOrder(WC_Order $order): array
    {
        ...
        foreach (self::FIELD_MAPPING as $metabox_key => $zerosense_key) {
            ...
            if ($metabox_value !== '' && $metabox_value !== null) {
                // Check if ZeroSense field already exists
    ...
    /**
     * Rollback migration for a single order
     */
